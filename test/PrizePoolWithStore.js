...
describe('PrizePool', function() {
  ...
  let prizePool, erc20token, erc721token, yieldSourceStub, prizeStrategy, reserve, reserveRegistry, storeRegistry
  ...
  beforeEach(async () => {
    ...
    const ERC721StoreRegistry = await hre.artifacts.readArtifact("ERC721StoreRegistry")
    storeRegistry = await deployMockContract(wallet, ERC721StoreRegistry.abi, overrides)
